...
class LabelDialog(QtWidgets.QDialog):
    def __init__(
        ...
        if QT6:
            bb.button(QtWidgets.QDialogButtonBox.Ok).setIcon(utils.newIcon("done"))
            bb.button(QtWidgets.QDialogButtonBox.Cancel).setIcon(utils.newIcon("undo"))
        else:
