...
class RectHandle(QtWidgets.QGraphicsRectItem):
    ...
    def update_handles_pos(self):
        ...
        offset_y = b.height()/2
        # 设置 handles 的位置
        self.handles[0] = QtCore.QRectF(x1-o, y1-o, s, s)
...
class RectItem(RectHandle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setFlags(QtWidgets.QGraphicsItem.ItemIsSelectable |  # 设定矩形框为可选择的
                      QtWidgets.QGraphicsItem.ItemSendsGeometryChanges |  # 追踪图元改变的信息
                      QtWidgets.QGraphicsItem.ItemIsFocusable |  # 可聚焦
                      QtWidgets.QGraphicsItem.ItemIsMovable)  # 可移动
    ...
    def paint(self, painter, option, widget=None):
        ...
        painter.setPen(QtGui.QPen(QtGui.QColor(0, 0, 0), 0, QtCore.Qt.SolidLine))
        painter.drawRect(self.rect())

        painter.setRenderHint(QtGui.QPainter.Antialiasing)
        painter.setBrush(QtGui.QBrush(QtGui.QColor(255, 255, 0, 200)))
        painter.setPen(QtGui.QPen(QtGui.QColor(0, 0, 0, 255), 0,
    ...
    def hoverMoveEvent(self, event):
        ...
        cursor = self.handle_cursors[handle] if handle in self.handles else QtCore.Qt.ArrowCursor
    ...
    def hoverLeaveEvent(self, event):
        ...
        self.setCursor(QtCore.Qt.ArrowCursor)  # 设定鼠标光标形状
